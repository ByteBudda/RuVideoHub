...
RuVideoHub — это альтернативный клиент, созданный с акцентом на удобство, оффлайн-функции и чистый код.
...
**SmartEngine** — собственный движок, который:
...
1. Скачайте последнюю сборку из [Releases](https://github.com/ByteBudda/ruvideohub/releases)
...
- Приложение использует публичные API. Использование может противоречить их Пользовательскому соглашению.
